...
public class DefaultValues {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Default Value of char is ="+ def.b);
        System.out.println("Default Value of boolean is ="+ def.c);
        System.out.println("Default Value of float is ="+ def.bo);
